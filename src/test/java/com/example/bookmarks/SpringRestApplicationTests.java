...
public class SpringRestApplicationTests {
    ...
    public void userNotFound() throws Exception {
        mockMvc.perform(post("/georg/bookmarks/").content(this.json(new Bookmark())).contentType(contentType)).
                andExpect(status().isNotFound());
    }

    @Test
    public void readSingleBookmark() throws Exception {
        ResultActions result = mockMvc.perform(get("/" + userName + "/bookmarks/" + this.bookmarkList.get(0).getId()));
    ...
    public void createBookmark() throws Exception {
        ...
        mockMvc.perform(post("/" + userName + "/bookmarks").contentType(contentType).content(bookmarkJson)).andExpect(status().isCreated());
    }
